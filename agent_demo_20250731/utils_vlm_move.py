...
def vlm_move(PROMPT='', input_way='keyboard'):
    ...
    # 起点，机械臂坐标
    START_X_MC, START_Y_MC = map_image_to_robot(START_X_CENTER, START_Y_CENTER)
    # 终点，机械臂坐标
    END_X_MC, END_Y_MC = map_image_to_robot(END_X_CENTER, END_Y_CENTER)
    
    ## 第七步：吸泵吸取移动物体
    print('第七步：吸泵吸取移动物体')
    pump_move(XY_START=[START_X_MC, START_Y_MC], XY_END=[END_X_MC, END_Y_MC])
