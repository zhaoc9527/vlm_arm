...
def record_Win(MIC_INDEX=0, DURATION=5, RATE=16000, OUTPUT_PATH='temp/speech_record.wav'):
    '''
    在 Windows 上使用 PyAudio 录音。
    MIC_INDEX: 麦克风设备索引（可以通过 list_microphones 查看）
    DURATION: 录音时长（秒）
    RATE: 采样率，默认 16000
    '''
